...
class WeekNotStartedResults:
    ...
    def week_results(self):
        ...
        self.utils.add_week_result(results,rank=1,projected_rank=1,player_name='Kevin',wins=0,losses=0,win_pct=0.000,projected_wins=10,possible_wins=10)
        self.utils.add_week_result(results,rank=1,projected_rank=1,player_name='John',wins=0,losses=0,win_pct=0.000,projected_wins=10,possible_wins=10)
        return results
