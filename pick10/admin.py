...
def show_week_year_week_num(obj):
    return 'Year=%d, Week=%d, Game=%d' % (obj.week.week_year, obj.week.week_num, obj.game_num,)

class GameAdmin(admin.ModelAdmin):
    list_display = (show_week_year_week_num, 'team1', 'team2', 'favored', 'spread', 'kickoff', 'created', 'updated')
