# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-12-16 00:46
...
class Migration(migrations.Migration):
    ...
    replaces = [('pick10', '0001_initial'), ('pick10', '0002_auto_20150802_2226'), ('pick10', '0003_auto_20150803_1514'), ('pick10', '0004_auto_20150812_1821'), ('pick10', '0005_auto_20150823_2117'), ('pick10', '0006_auto_20150830_1923'), ('pick10', '0007_userprofile_favorite_team'), ('pick10', '0008_auto_20150902_2138'), ('pick10', '0009_auto_20150902_2254'), ('pick10', '0010_pick_submit_time'), ('pick10', '0011_auto_20160822_2136'), ('pick10', '0012_auto_20170519_0749'), ('pick10', '0013_auto_20170521_1552'), ('pick10', '0014_auto_20180924_0029')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('div_name', models.CharField(blank=True, max_length=40, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True, auto_now_add=True)),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pick10.Game')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conference', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='pick10.Conference')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lock_picks', models.DateTimeField(blank=True, null=True)),
                ('lock_scores', models.BooleanField(default=False)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True, auto_now_add=True)),
                ('winner', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='pick10.Player')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_fee', models.DecimalField(decimal_places=2, default=10.0, max_digits=6)),
                ('payout_week', models.DecimalField(decimal_places=2, default=15.0, max_digits=6)),
                ('payout_first', models.DecimalField(decimal_places=2, default=0.0, max_digits=7)),
                ('payout_second', models.DecimalField(decimal_places=2, default=0.0, max_digits=7)),
                ('payout_third', models.DecimalField(decimal_places=2, default=0.0, max_digits=7)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='week',
            name='year',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pick10.Year'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='pick',
            name='player',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pick10.Player'),
        ),
        migrations.AddField(
            model_name='game',
            name='team1',
        ...
        migrations.AddField(
            model_name='game',
            name='week',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pick10.Week'),
        ),
