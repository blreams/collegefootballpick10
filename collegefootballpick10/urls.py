...
urlpatterns = [
    ...
    url(r'^admin/password_reset/$', auth_views.PasswordChangeView.as_view, name='admin_password_reset'),
    url(r'^admin/password_reset/done/$', auth_views.PasswordChangeDoneView.as_view, name='admin_password_reset_done'),
