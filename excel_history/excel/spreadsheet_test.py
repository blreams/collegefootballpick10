...
team_mascot_conference_division = {
    # American Athletic
    ...
    'Southern Methodist': 'Mustangs:American Athletic:',
    'Temple': 'Owls:American Athletic:',
    'Tulane': 'Green Wave:American Athletic:',
    'Tulsa': 'Golden Hurricane:American Athletic:',
    'UCF': 'Knights:American Athletic:',

    # Atlantic Coast - Atlantic
    'Boston College': 'Eagles:Atlantic Coast:Atlantic',
    'Clemson': 'Tigers:Atlantic Coast:Atlantic',
    'Florida State': 'Seminoles:Atlantic Coast:Atlantic',
    'Louisville': 'Cardinals:Atlantic Coast:Atlantic',
    'NC State': 'Wolfpack:Atlantic Coast:Atlantic',
    'Syracuse': 'Orange:Atlantic Coast:Atlantic',
    'Wake Forest': 'Demon Deacons:Atlantic Coast:Atlantic',
    # Atlantic Coast - Coastal
    'Duke': 'Blue Devils:Atlantic Coast:Coastal',
    'Georgia Tech': 'Yellow Jackets:Atlantic Coast:Coastal',
    'Miami-Florida': 'Hurricanes:Atlantic Coast:Coastal',
    'North Carolina': 'Tarheels:Atlantic Coast:Coastal',
    'Pittsburgh': 'Panthers:Atlantic Coast:Coastal',
    'Virginia': 'Cavaliers:Atlantic Coast:Coastal',
    'Virginia Tech': 'Hokies:Atlantic Coast:Coastal',

    # Big Ten - East
    'Indiana': 'Hoosiers:Big Ten:East',
    'Maryland': 'Terrapins:Big Ten:East',
    ...
    # Conference USA - East
    'Florida Atlantic': 'Owls:Conference USA:East',
    'Florida International': 'Golden Panthers:Conference USA:East',
    'Marshall': 'Thundering Herd:Conference USA:East',
    'Middle Tennessee': 'Blue Raiders:Conference USA:East',
    'Old Dominion': 'Monarchs:Conference USA:East',
    'UAB': 'Blazers:Conference USA:East',
    'Western Kentucky': 'Hilltoppers:Conference USA:East',
    # Conference USA - West
    'Louisiana Tech': 'Bulldogs:Conference USA:West',
    'North Texas': 'Mean Green:Conference USA:West',
    'Rice': 'Owls:Conference USA:West',
    'Southern Miss': 'Golden Eagles:Conference USA:West',
    'Texas-El Paso': 'Miners:Conference USA:West',
    'Texas-San Antonio': 'Road Runners:Conference USA:West',

    # Independents
    'Army': 'Black Knights:Independents:',
    'BYU': 'Cougars:Independents:',
    'Navy': 'Midshipmen:Independents:',
    'Notre Dame': 'Fighting Irish:Independents:',

    # Mid American - East
    'Akron': 'Zips:Mid American:East',
    'Bowling Green': 'Falcons:Mid American:East',
    'Buffalo': 'Bulls:Mid American:East',
    'Kent State': 'Golden Flashes:Mid American:East',
    'Massachusetts': 'Minutemen:Mid American:East',
    'Miami-Ohio': 'Redhawks:Mid American:East',
    'Ohio': 'Bobcats:Mid American:East',
    # Mid American - West
    'Ball State': 'Cardinals:Mid American:West',
    'Central Michigan': 'Chippewas:Mid American:West',
    'Eastern Michigan': 'Eagles:Mid American:West',
    'Northern Illinois': 'Huskies:Mid American:West',
    'Toledo': 'Rockets:Mid American:West',
    'Western Michigan': 'Broncos:Mid American:West',

    # Mountain West - Mountain
    'Air Force': 'Falcons:Mountain West:Mountain',
    'Boise State': 'Broncos:Mountain West:Mountain',
    'Colorado State': 'Rams:Mountain West:Mountain',
    'New Mexico': 'Lobos:Mountain West:Mountain',
    'Utah State': 'Aggies:Mountain West:Mountain',
    'Wyoming': 'Cowboys:Mountain West:Mountain',
    # Mountain West - West
    'Fresno State': 'Bulldogs:Mountain West:West',
    'Hawaii': 'Rainbox Warriors:Mountain West:West',
    'Nevada': 'Wolf Pack:Mountain West:West',
    'San Diego State': 'Aztecs:Mountain West:West',
    'San Jose State': 'Spartans:Mountain West:West',
    'UNLV': 'Rebels:Mountain West:West',

    # Pacific 12 - North
    'California': 'Golden Bears:Pacific 12:North',
    'Oregon': 'Ducks:Pacific 12:North',
    'Oregon State': 'Beavers:Pacific 12:North',
    'Stanford': 'Cardinal:Pacific 12:North',
    'Washington': 'Huskies:Pacific 12:North',
    'Washington State': 'Cougars:Pacific 12:North',
    # Pacific 12 - South
    'Arizona': 'Wildcats:Pacific 12:South',
    'Arizona State': 'Sun Devils:Pacific 12:South',
    'Colorado': 'Buffaloes:Pacific 12:South',
    'Southern Cal': 'Trojans:Pacific 12:South',
    'UCLA': 'Bruins:Pacific 12:South',
    'Utah': 'Utes:Pacific 12:South',

    # Southeastern - East
    'Florida': 'Gators:Southeastern:East',
    'Georgia': 'Bulldogs:Southeastern:East',
    'Kentucky': 'Wildcats:Southeastern:East',
    'Missouri': 'Tigers:Southeastern:East',
    'South Carolina': 'Gamecocks:Southeastern:East',
    'Tennessee': 'Volunteers:Southeastern:East',
    'Vanderbilt': 'Commodores:Southeastern:East',
    # Southeastern - West
    'Alabama': 'Crimson Tide:Southeastern:West',
    'Arkansas': 'Razorbacks:Southeastern:West',
    'Auburn': 'Tigers:Southeastern:West',
    'LSU': 'Tigers:Southeastern:West',
    'Mississippi State': 'Bulldogs:Southeastern:West',
    'Mississippi': 'Rebels:Southeastern:West',
    'Texas A&M': 'Aggies:Southeastern:West',

    # Sun Belt
    'Appalachian State': 'Mountaineers:Sun Belt:',
    'Arkansas State': 'Red Wolves:Sun Belt:',
    'Georgia Southern': 'Eagle:Sun Belt:',
